                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    <Form.Group controlId="EmployeeId">
                                        ...
                                        required disabled defaultValue={this.props.empid}
                                    ...
                                    <Form.Group controlId="DateOfJoining">
                                        ...
                                        <Form.Control type="date" name="DateOfJoining" required placeholder="DateOfJoining" defaultValue={this.props.doj}></Form.Control>
                                    </Form.Group>
